...
from pyactus.typeset import TermsForUndefinedMaturityProfile as ContractTerms
...
def execute_step(
    ...
    :param terms: The contract term set.
...
def get_schedule(to_date: datetime.datetime, terms: ContractTerms) -> typing.List[Event]:
